...
//commons
_uniform = "UK3CB_BAF_U_CombatUniform_MTP";
_vest = "UK3CB_BAF_V_Osprey_Rifleman_A";
_backpack = "B_AssaultPack_rgr";
_headgear = "UK3CB_BAF_H_Mk7_Camo_A";
...
//Leader
_backpackLeader = "UK3CB_BAF_B_Bergen_MTP_SL_L_A";
