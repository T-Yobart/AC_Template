...
_availableUniforms = [
	"Uniform_Full_CADPAT",
	"Uniform_Rolled_CADPAT",
	"Uniform_Tanktop_CADPAT",
	"Uniform_Coveralls_CADPAT"
];

_availableVests = [
	"vest_spc_CADPAT",
	"vest_spc_crewman_CADPAT",
	"vest_spc_radio_CADPAT",
	"vest_spc_rifleman_CADPAT"
];

_availableBackpacks = [
	"CADPAT_Assaultpack",
	"CADPAT_Medicpack",
	"clf_CADPAT_prc117g_co",
	"unv_CADPAT_big_rt1523g",
	"CADPAT_B_RadioBag_01"
];
